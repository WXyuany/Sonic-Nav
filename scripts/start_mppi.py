...
time.sleep(2)
run_script("scene_map_server.py", "MAP", SCENE_XML)
time.sleep(1)
run_script("astar_global_planner.py", "GLOBAL_PLANNER")
time.sleep(1)
run_script("nav_control_adapter.py", "NAV_ADAPTER")
time.sleep(1)
run_script("mid360_pub.py", "MID360", SCENE_XML)
time.sleep(2)
run_script("local_costmap_server.py", "LOCAL_COSTMAP")
time.sleep(1)
run_script("nav_metrics.py", "NAV_METRICS")
time.sleep(1)
